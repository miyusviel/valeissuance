...
import static Others.functions.GetUser;
 ...
 * @author RaeYobz
 */
public class FuelAccountsPayable extends javax.swing.JDialog {
     ...
     */
    public FuelAccountsPayable(main_menu parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Fuel/Oil Accounts Payable Report");
    ...
    private void genReportBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_genReportBtnActionPerformed
        ...
        //Tawag sulay ang user ID
        Integer userId = UserContext.getInstance().getUserId(); //bisan asa pwd tawagon ni
        GetUser(userId);

        //  JOptionPane.showMessageDialog(null, userId+"  " + fname);
        // Call the function
        reports.rptFuelAccountPayable(formattedStartDate, formattedEndDate, fname);// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FuelAccountsPayable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
